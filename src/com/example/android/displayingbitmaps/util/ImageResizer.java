...
public class ImageResizer extends ImageWorker {
   ...
   * This implementation calculates the closest inSampleSize that is a power of 2 and will result in
   * the final decoded bitmap having a width and height equal to or larger than the requested width
   * and height.
   *
