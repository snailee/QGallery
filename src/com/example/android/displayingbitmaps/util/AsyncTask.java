 ...
 * .com/platform/frameworks/base/+/jb-release/core/java/android/os/AsyncTask.java
 * 
...
public abstract class AsyncTask<Params, Progress, Result> {
   ...
   * 
   * <p>
   * The default implementation simply invokes {@link #onCancelled()} and ignores the result. If you
   * write your own implementation, do not call <code>super.onCancelled(result)</code>.
   * </p>
   * 
   ...
   * 
   * <p>
   * Calling this method will result in {@link #onCancelled(Object)} being invoked on the UI thread
   * after {@link #doInBackground(Object[])} returns. Calling this method guarantees that
   ...
   * 
   * <p>
   * This method is typically used with {@link #THREAD_POOL_EXECUTOR} to allow multiple tasks to run
   * in parallel on a pool of threads managed by AsyncTask, however you can also use your own
